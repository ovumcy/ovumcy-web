...
func TestImportJSONRejectsMissingCSRF(t *testing.T) {
	...
	response, err := ctx.app.Test(newImportRequest(ctx, body, false))
	if err != nil {
...
func TestImportJSONSucceedsWithCSRF(t *testing.T) {
	...
	response, err := ctx.app.Test(newImportRequest(ctx, body, true))
	if err != nil {
...
func TestImportJSONRejectsMalformedFile(t *testing.T) {
	...
	response, err := ctx.app.Test(newImportRequest(ctx, "{not valid json", true))
	if err != nil {
...
func TestImportJSONHTMXSuccessReturnsStatusMarkup(t *testing.T) {
	...
	response, err := ctx.app.Test(request)
	if err != nil {
