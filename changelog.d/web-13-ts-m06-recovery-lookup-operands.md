...
its own — plus the target bcrypt cost of both placeholders. The existing
guard only counted the calls, so a body comparing the wrong operand against a
placeholder still passed it. No wall-clock assertion is involved.
